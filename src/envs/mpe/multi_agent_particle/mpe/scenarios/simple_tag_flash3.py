...
class Scenario(BaseScenario):
    def make_world(self):
        ...
        for i, agent in enumerate(world.agents):
            ...
            agent.size = 0.12 + EPS if agent.adversary else 0.05 + EPS
            agent.accel = 3.0 + EPS if agent.adversary else 15 + EPS
            #agent.accel = 20.0 if agent.adversary else 25.0
            agent.max_speed = 1.0 + EPS if agent.adversary else 12 + EPS
        # add landmarks
